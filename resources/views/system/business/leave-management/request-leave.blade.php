    ...
    <div class="content">
        ...
        <div class="d-md-flex d-block align-items-center justify-content-between page-breadcrumb">
            <div class="my-auto mb-2">
                <h3 class="mb-1">Request Leave</h3>
                <nav>
                    <ol class="breadcrumb mb-0">
                        ...
                        <li class="breadcrumb-item">
                            <a href="{{ url('/dashboard') }}">Request Leave</a>
                        </li>
                    </ol>
                </nav>
            </div>
                ...
                <div class="card-body">
                    ...
                    <div class="d-flex justify-content-between">
                        <div class="action-area ms-auto">
                            <button class="btn btn-primary skeleton-popup" id="configs-add-btn"
                                data-token="@skeletonToken('business_leave_requests')_a" data-text="Request Leave" data-target="#configs-add-btn">
                                Request Leave
                            </button>
                        </div>
                    </div>
                    ...
                    <div class="tab-content" id="skeletonTabsContent">
                        <div class="tab-pane fade show active" id="configs" role="tabpanel" aria-labelledby="configs-tab">
                            <div data-skeleton-table-set="@skeletonToken('business_leave_requests')_f"></div>
                        </div>
                    </div>
                </div>
            </div>
