    ...
    <div class="content">
        ...
        <div class="d-md-flex d-block align-items-center justify-content-between page-breadcrumb">
            <div class="my-auto mb-2">
                <h3 class="mb-1">Shift Schedules</h3>
                <nav>
                    <ol class="breadcrumb mb-0">
                        ...
                        <li class="breadcrumb-item">
                            <a href="{{ url('/dashboard') }}">Shift Schedules</a>
                        </li>
                    </ol>
                </nav>
            </div>
                ...
                <div class="card-body">
                        ...
                        <ul class="nav nav-tabs nav-tabs-solid bg-transparent border-bottom-0 mb-3 data-skl-action"
                            ...
                            <li class="nav-item">
                                <a class="nav-link active" id="Shifts-tab" data-skl-action="b" data-bs-toggle="tab"
                                    ...
                                    data-token="@skeletonToken('business_shift_schedules')_a" data-text="Add Schedules"
                                    data-target="#Shifts-add-btn">Shift Schedule</a>
                            </li>
                        </ul>
                    ...
                    <div class="tab-content" id="skeletonTabsContent">
                        <div class="tab-pane fade show active" id="Shifts" role="tabpanel"
                            ...
                            <div data-skeleton-table-set="@skeletonToken('business_shift_schedules')_f"></div>
                        </div>
                    </div>
                </div>
            </div>
