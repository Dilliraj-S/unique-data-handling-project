 ...
 */
  var hljs=function(){"use strict";function e(t){
    ...
    ;hljs.registerLanguage("haml",e)})();/*! `ini` grammar compiled for Highlight.js 11.10.0 */
    ...
    contains:[o]}]}}})();hljs.registerLanguage("vbnet",e)})();/*! `vbscript-html` grammar compiled for Highlight.js 11.10.0 */
    (()=>{var e=(()=>{"use strict";return e=>({name:"VBScript in HTML",
    subLanguage:"xml",contains:[{begin:"<%",end:"%>",subLanguage:"vbscript"}]})})()
    ;hljs.registerLanguage("vbscript-html",e)})();/*! `wasm` grammar compiled for Highlight.js 11.10.0 */
