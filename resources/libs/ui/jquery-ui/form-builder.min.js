            ...
            (function () {
                ...
                const w = {
                    ...
                    backends: {
                        ...
                        dompurify: !!window.DOMPurify && ((y = window.DOMPurify), y.setConfig({ SANITIZE_DOM: !1, ADD_ATTR: ["contenteditable"] }), y),
                        fallback: (e) => e,
                    },
                };
                var y;
                ...
                const A = (e) => {
                    ...
                    O = function (t, r, o) {
                        if ((void 0 === o && (o = !1), !o)) {
                            ...
                            return void 0 !== w.backendOrder.find((e) => C[e](o, r))
                                ? (((t) => {
                                      e(t)
                                          .find("*")
                                          .each((e, t) => {
                            ...
                            ? E(Object(r), !0).forEach(function (t) {
                                  ...
                                  (o = e),
                                      ...
                                      (n = (function (e) {
                                          ...
                                          ? Object.defineProperty(o, n, { value: i, enumerable: !0, configurable: !0, writable: !0 })
                                          : (o[n] = i);
                              })
                ...
                const T = function (e, t) {
                    ...
                    R = (e, t) => {
                        let r;
                        return (e = M(e)), t && (Array.isArray(t) ? (r = G(t.join(" "))) : ("boolean" == typeof t && (t = t.toString()), (r = G(t.trim())))), { name: e, value: (t = t ? `="${r}"` : "") };
                    },
                    I = (e) => e.reduce((e, t) => e.concat(Array.isArray(t) ? I(t) : t), []),
                    M = (e) => ({ className: "class" }[e] || P(e)),
                    P = (e) =>
                    ...
                    U = (e) => {
                        ...
                        for (let r = 0; r < e.length; r++) {
                            const o = S(S({}, z(e[r])), {}, { label: e[r].textContent });
                            t.push(o);
                        }
                        return t;
                    },
                ...
                class pe {
                    constructor(e, t) {
                        ...
                        e.id || (e.name ? (e.id = e.name) : (e.id = "control-" + Math.floor(1e7 * Math.random() + 1))),
                            ...
                            pe.controlConfig || (pe.controlConfig = {});
                        const o = this.subtype ? this.type + "." + this.subtype : this.type;
                        (this.classConfig = jQuery.extend({}, pe.controlConfig[this.type] || {}, pe.controlConfig[o] || {})),
                ...
                class be {
                    constructor(e, t, r, o) {
                        ...
                        void 0 === t && (t = !1),
                            void 0 === r && (r = !1),
                            void 0 === o && (o = {}),
                            (this.preview = null !== (n = t) && void 0 !== n && n),
                            (this.disableHTMLLabels = null !== (i = r) && void 0 !== i && i),
                            (this.controlConfig = null !== (l = o) && void 0 !== l ? l : {}),
                            (this.templates = {
                                label: null,
                                help: null,
                                default: (e, t, r, o) => (r && t.appendChild(r), this.markup("div", [t, e], { className: me(o, e) })),
                                noLabel: (e, t, r, o) => this.markup("div", e, { className: me(o, e) }),
                                hidden: (e) => e,
                            }),
                ...
                const ge = {
                    ...
                    we = { location: "assets/lang/" },
                    ye = {},
                    xe = { rowWrapperClass: "rowWrapper", colWrapperClass: "colWrapper", tmpRowPlaceholderClass: "tempRowWrapper", invisibleRowPlaceholderClass: "invisibleRowPlaceholder" };
                var Ae = o(54),
                    Ce = o.n(Ae);
                const Oe = ["values"],
                    ke = ["label", "events"],
                ...
                class Se {
                                        ...
                                        if (!i.hasClass("disabled-field")) {
                                            ...
                                            if (
                                                ...
                                                l.className &&
                                                    ...
                                                    1 == i.closest(this.formBuilder.rowWrapperClassSelector).children().length &&
                                                    l.className.includes(ye.opts.defaultGridColumnClass))
                                            ) {
                    ...
                    getData(e) {
                        ...
                        const r = { xml: (e) => (Array.isArray(e) ? e : $(e)), json: (e) => ("string" == typeof e ? window.JSON.parse(e) : e) };
                    ...
                    disabledTT(e) {
                        ...
                        X(t, (e) => {
                            ...
                            if (o) {
                                const e = q("p", o, { className: "frmb-tt" });
                                r.appendChild(e),
                    ...
                    closeConfirm(e, t) {
                        e || (e = document.getElementsByClassName("form-builder-overlay")[0]),
                            ...
                            document.dispatchEvent(v.modalClosed);
                    }
                    handleKeyDown(e) {
                    ...
                    showOverlay() {
                        const e = q("div", null, { className: "form-builder-overlay" });
                        return (
                    ...
                    confirm(e, t, r, o) {
                        ...
                        const n = this,
                            i = h().current,
                            l = n.showOverlay(),
                            a = q("button", i.yes, { className: "yes btn btn-success btn-sm" }),
                            s = q("button", i.no, { className: "no btn btn-danger btn-sm" });
                        (s.onclick = function () {
                            n.closeConfirm(l);
                        }),
                            (a.onclick = function () {
                        ...
                        const d = q("div", [s, a], { className: "button-wrap" }),
                            c = q("div", [e, d], { className: (o = "form-builder-dialog " + o) });
                    ...
                    dialog(e, t, r) {
                        ...
                        this.showOverlay();
                        const i = q("div", e, { className: (r = "form-builder-dialog " + r) });
                        return (
                            ...
                            document.dispatchEvent(v.modalOpened),
                            -1 !== r.indexOf("data-dialog") && document.dispatchEvent(v.viewData),
                            i
                        );
                    }
                    confirmRemoveAll(t) {
                    ...
                    setFieldOrder(t) {
                        ...
                        return (
                            ...
                            Ce()("sessionStorage") && window.sessionStorage.setItem("fieldOrder", r.stringify(o)),
                            o
                        );
                    }
                    closeAllEdit() {
                    ...
                    openField(t, r) {
                        ...
                        return (
                            ...
                            ye.opts.onOpenFieldEdit(n[0]),
                            document.dispatchEvent(v.fieldEditOpened),
                        ...
                        e(window).scroll(function (l) {
                            ...
                            if (a > i) {
                                const e = { position: "sticky" },
                                    ...
                                    c = l.top + l.height,
                                    f = s === c && i.top > a;
                                s > c && i.top !== l.top && o.css({ position: "absolute", top: "auto", bottom: 0, right: 0, left: "auto" }), (s < c || f) && o.css(n);
                            } else t.parentElement.removeAttribute("style");
                        });
                    }
                    showData() {
                        const e = J(this.getFormData(ye.opts.dataType, !0)),
                            t = q("code", e, { className: `formData-${ye.opts.dataType}` });
                    ...
                    removeField(t, r) {
                        ...
                        if (!t) {
                            ...
                            ye.opts.notify.warning("fieldID required to remove specific fields."),
                                ye.opts.notify.warning("Removing last field since no ID was supplied."),
                                ye.opts.notify.warning("Available IDs: " + e.join(", ")),
                                (t = i.lastChild.id);
                        }
                    ...
                    editorUI(e) {
                        const t = this.d,
                            r = this.data,
                            o = e || r.formID;
                        (t.editorWrap = q("div", null, { id: `${r.formID}-form-wrap`, className: `form-wrap form-builder formbuilder-embedded-bootstrap ${ne()}` })),
                            (t.stage = q("ul", null, { id: o, className: `frmb stage-wrap ${r.layout.stage}` })),
                            (t.controls = q("ul", null, { id: `${o}-control-box`, className: "frmb-control" }));
                        const n = this.formActionButtons();
                        t.formActions = q("div", n, { className: "form-actions btn-group" });
                    }
                    formActionButtons() {
                        const e = ye.opts;
                    ...
                    processOptions(e) {
                        ...
                        return (
                            ...
                            (ye.opts = Object.assign({}, { actionButtons: l }, { fieldEditContainer: i }, n)),
                            ye.opts
                        );
                    }
                    input(e) {
                ...
                class Re extends pe {
                    build() {
                        ...
                        return n[t] && (o = n[t]), { field: this.markup(o, fe.parsedHtml(this.label), r), layout: "noLabel" };
                    }
                }
                ...
                pe.register(
                    ...
                    class extends pe {
                        ...
                        build() {
                            ...
                            return (this.dom = "select" == i ? this.markup(c, e, T(d, !0)) : this.markup("div", e, { className: i })), this.dom;
                        }
                        groupRequired() {
                ...
                pe.register(["text", "file", "date", "number"], Be),
                    pe.register(["text", "password", "email", "color", "tel"], Be, "text"),
                    pe.register(["date", "time", "datetime-local"], Be, "date"),
                    pe.register(["number", "range"], Be, "number");
                const Fe = ["value"];
                class He extends pe {
                    static get definition() {
                ...
                He.register(
                    ...
                    class extends He {
                        configure() {
                            ...
                            Object.assign(this, We(We({}, { js: "https://cdn.quilljs.com/1.2.4/quill.js", css: "https://cdn.quilljs.com/1.2.4/quill.snow.css" }), t)), (this.editorConfig = We(We({}, e), r));
                        }
                        build() {
                            const e = this.config,
                                { value: t = "" } = e,
                ...
                class $e {
                    constructor(e, t) {
                        void 0 === e && (e = {}), void 0 === t && (t = []), (this.customRegister = {}), (this.templateControlRegister = {}), (this.def = { icon: {}, i18n: {} }), this.register(e, t);
                    }
                    register(e, t) {
                        ...
                        Object.keys(e).forEach((t) => {
                            const r = function (r, o) {
                                (this.customControl = new De(r, o, e[t])),
                                    (this.build = function () {
                ...
                class Ge {
                    ...
                    setupControls() {
                        ...
                        for (let e = 0; e < t.length; e++) {
                            ...
                            const s = q("li", q("span", l), { className: `${a} input-control input-control-${e}` });
                        ...
                        e.inputSets.length &&
                            e.inputSets.forEach((e, t) => {
                                ...
                                const n = q("li", q("span", o), { className: `input-set-control input-set-${t}` });
                    ...
                    orderFields(e) {
                        ...
                        let o;
                        return (
                            Ce()("sessionStorage") && (t.sortableControls ? (o = window.sessionStorage.getItem("fieldOrder")) : window.sessionStorage.removeItem("fieldOrder")),
                            o ? ((o = window.JSON.parse(o)), (o = Q(o.concat(e))), (o = Object.keys(o).map((e) => o[e]))) : (o = Q(r)),
                            o.forEach((e) => {
                ...
                const rt = Ve.Rp,
                    { rowWrapperClass: ot, colWrapperClass: nt, tmpRowPlaceholderClass: it, invisibleRowPlaceholderClass: lt } = xe,
                    { rowWrapperClassSelector: at, colWrapperClassSelector: st, tmpRowPlaceholderClassSelector: dt, invisibleRowPlaceholderClassSelector: ct } =
                        ((ft = xe),
                        Object.entries(ft).reduce((e, t) => {
                            let [r, o] = t;
                            return S(S({}, e), {}, { [`${r}Selector`]: `.${o}` });
                        }, {}));
                var ft;
                function ut(e, t, o) {
                    const n = this,
                    ...
                    (n.preserveTempContainers = []),
                        (n.rowWrapperClassSelector = at),
                        (n.colWrapperClassSelector = st),
                        (n.colWrapperClass = nt),
                        (n.fieldSelector = e.enableEnhancedBootstrapGrid ? at : "li.form-field"),
                        ((e) => {
                    ...
                    x.sortable({
                        ...
                        e.allowStageSort || x.sortable("disable"),
                        A.sortable({
                            helper: "clone",
                            opacity: 0.9,
                            connectWith: `#${l}, ${at}`,
                    ...
                    const I = b("div", d.controls, { id: `${s.formID}-cb-wrap`, className: `cb-wrap ${s.layout.controls}` });
                    e.showActionButtons && I.appendChild(d.formActions);
                    const M = b("div", "", { id: `${s.formID}-gridModeHelp`, className: "grid-mode-help" });
                    I.appendChild(M),
                        R.append(d.stage, I),
                        "textarea" !== t.type ? o(t).append(R) : o(t).replaceWith(R),
                        o(d.controls).on("click", "li", (t) => {
                            let { target: r } = t;
                    ...
                    n.prepFieldVars = B;
                    const z = function (t) {
                        (t = p.getData(t)) && t.length
                            ? (t.forEach((e) => U(e)), t.forEach((e) => B(T(e))), d.stage.classList.remove("empty"))
                            : e.defaultFields && e.defaultFields.length
                            ? (ye.opts.defaultFields.forEach((e) => U(e)), p.addDefaultFields())
                            : e.prepend || e.append || (d.stage.classList.add("empty"), (d.stage.dataset.content = h().get("getStarted"))),
                            (() => {
                                const t = [],
                                    r = (t) => b("li", e[t], { className: `disabled-field form-${t}` });
                                return (
                                    e.prepend && !o(".disabled-field.form-prepend", d.stage).length && (t.push(!0), x.prepend(r("prepend"))),
                                    e.append && !o(".disabled-field.form-append", d.stage).length && (t.push(!0), x.append(r("append"))),
                                    p.disabledTT(d.stage),
                                    t.some((e) => !0 === e)
                                );
                    ...
                    const W = (t) => {
                        const { type: r } = t,
                            ...
                            l = {
                                required: () => de(t),
                                toggle: () => K("toggle", t, { first: h().get("toggle") }),
                                inline: () => {
                                ...
                                other: () => K("other", t, { first: h().get("enableOther"), second: h().get("enableOtherMsg") }),
                                options: () =>
                                    (function (e) {
                                        const { type: t, values: r } = e;
                                        let o;
                                        const n = [b("a", h().get("addOption"), { className: "add add-opt" })],
                                            i = [b("label", h().get("selectOptions"), { className: "false-label" })],
                                            l = e.multiple || "checkbox-group" === t,
                                            a = (e) => {
                                                const t = h().get("optionCount", e);
                                                return { selected: !1, label: t, value: P(t) };
                                            };
                                        ...
                                        const s = b("div", n, { className: "option-actions" }),
                                            d = b(
                                                "ol",
                                                o.map(function (r, o, n, i) {
                                                    void 0 === i && (i = e.name);
                                                    const a = ye.opts.onAddOption(r, { type: t, index: o, isMultiple: l });
                                                    return ke(i + "-options", a, l);
                                                }),
                                                { className: "sortable-options" }
                                            ),
                                            c = b("div", [d, s], { className: "sortable-options-wrap" });
                                        return i.push(c), b("div", i, { className: "form-group field-options" }).outerHTML;
                                    })(t),
                                requireValidOption: () => K("requireValidOption", t, { first: " ", second: h().get("requireValidOption") }),
                                multiple: () => {
                                    const e = {
                    ...
                    function Q(e, t) {
                        const { class: r, className: o } = t,
                            n = _e(t, Xe);
                        let l = { id: e + "-" + s.lastID, title: n.description || n.label || e.toUpperCase(), name: e, type: n.type || "text", className: [`fld-${e}`, (r || o || "").trim()], value: n.value || "" };
                        ...
                        return (
                            ...
                            `<div class="form-group ${e}-wrap">${a}<div class="input-wrap">${(() => {
                                if ("textarea" === l.type) {
                                    const e = l.value;
                                    return delete l.value, `<textarea ${L(l)}>${e}</textarea>`;
                                }
                                return `<input ${L(l)}>`;
                            })()}</div></div>`
                        );
                    ...
                    function Y(e, t) {
                        const { multiple: r, options: o, label: n, value: l, class: a, className: d } = t,
                            ...
                            u = { id: `${e}-${s.lastID}`, title: c.description || n || e.toUpperCase(), name: e, className: `fld-${e} form-control ${a || d || ""}`.trim() };
                        r && (u.multiple = !0);
                    ...
                    const K = function (e, t, r) {
                            void 0 === r && (r = {});
                            const o = (t) => b("label", t, { for: `${e}-${s.lastID}` }).outerHTML,
                            ...
                            return (
                                ...
                                (l = b("div", l, { className: "input-wrap" }).outerHTML),
                                b("div", i.concat(l), { className: `form-group ${e}-wrap` }).outerHTML
                            );
                        },
                        _ = (e) => {
                            let t = "";
                            ...
                            return (
                                (t += p.input({ value: e || "default", type: "hidden", className: "btn-style" }).outerHTML),
                                (t += '<div class="btn-group" role="group">'),
                                ve.btn.forEach((r) => {
                                    const o = ["btn-xs", "btn", `btn-${r}`];
                                    e === r && o.push("selected");
                                    const n = b("button", h().get(`styles.btn.${r}`), { value: r, type: "button", className: o.join(" ") }).outerHTML;
                                    t += n;
                                }),
                                (t += "</div>"),
                                (t = b("div", [r, t], { className: "form-group style-wrap" })),
                                t.outerHTML
                            );
                        },
                        te = (e, t) => {
                            ...
                            return b("div", [`<label for="${a.id}">${l}</label>`, `<div class="input-wrap">${d}</div>`], { className: `form-group ${e}-wrap` }).outerHTML;
                        },
                        ne = function (e, t, r, o) {
                            void 0 === o && (o = !1);
                            const n = r.map((r, o) => {
                                ...
                                a = h().get(e) || ee(e) || "",
                                d = b("label", a, { for: l.id }),
                                c = b("select", n, l),
                                f = b("div", c, { className: "input-wrap" });
                            return b("div", [d, f], { className: `form-group ${l.name}-wrap`, style: "display: " + (o ? "none" : "block") }).outerHTML;
                        },
                        se = function (t, r, o) {
                            void 0 === o && (o = !1);
                            let n = r[t] || "",
                            ...
                            if (![].some((e) => !0 === e)) {
                                const d = { name: t, placeholder: l, className: `fld-${t} form-control`, id: `${t}-${s.lastID}` },
                                    c = b("label", i, { for: d.id }).outerHTML;
                                "label" !== t || e.disableHTMLLabels
                                    ? "textarea" === r.type && "value" === t
                                        ? (a += b("textarea", n, d).outerHTML)
                                        : ((d.value = n), (d.type = "text"), (a += `<input ${L(d)}>`))
                                    : ((d.contenteditable = !0), (a += b("div", n, d).outerHTML));
                                const f = `<div class="input-wrap">${a}</div>`;
                                let u = o ? "none" : "block";
                                "value" === t && (u = r.subtype && "quill" === r.subtype && "none"), (a = b("div", [c, f], { className: `form-group ${t}-wrap`, style: `display: ${u}` }));
                            }
                            return a.outerHTML;
                        },
                        de = (e) => {
                            const { type: t } = e,
                                r = [];
                            let o = "";
                            return ["header", "paragraph", "button"].includes(t) && r.push(!0), r.some((e) => !0 === e) || (o = K("required", e, { first: h().get("required") })), o;
                        },
                        ce = function (t, r) {
                            void 0 === r && (r = !0);
                            const l = Oe(t);
                            ...
                            let m = [
                                b("a", null, { type: "remove", id: "del_" + s.lastID, className: `del-button btn ${rt}cancel delete-confirm`, title: h().get("removeMessage") }),
                                b("a", null, { type: "edit", id: s.lastID + "-edit", className: `toggle-form btn ${rt}pencil`, title: h().get("hide") }),
                                b("a", null, { type: "copy", id: s.lastID + "-copy", className: `copy-button btn ${rt}copy`, title: h().get("copyButtonTooltip") }),
                            ];
                            N()
                                ? m.push(b("a", null, { type: "grid", id: s.lastID + "-grid", className: `grid-button btn ${rt}grid`, title: "Grid Mode" }))
                                : m.push(
                                      b("a", null, { type: "sort", id: s.lastID + "-sort-higher", className: `sort-button sort-button-higher btn ${rt}sort-higher`, title: "Move Higher" }),
                                      b("a", null, { type: "sort", id: s.lastID + "-sort-lower", className: `sort-button sort-button-lower btn ${rt}sort-lower`, title: "Move Lower" })
                                  ),
                                u && Array.isArray(u) && (m = m.filter((e) => !u.includes(e.type)));
                            const g = [b("div", m, { className: "field-actions" })],
                                v = e.disableHTMLLabels ? document.createTextNode(c) : V(c);
                            g.push(b("label", v, { className: "field-label" })), g.push(b("span", " *", { className: "required-asterisk", style: t.required ? "display:inline" : "" }));
                            const w = { className: "tooltip-element", tooltip: t.description, style: t.description ? "display:inline-block" : "display:none" };
                            g.push(b("span", "?", w));
                            const y = b("div", "", { className: "prev-holder", dataFieldId: s.lastID });
                            g.push(y);
                            const A = b("div", [W(t), b("a", h().get("close"), { className: "close-field" })], { className: "form-elements" }),
                                O = b("div", A, { id: `${s.lastID}-holder`, className: "frm-holder", dataFieldId: s.lastID });
                            (n.currentEditPanel = O), g.push(O);
                            const k = b("li", g, { class: `${a}-field form-field`, type: a, id: s.lastID }),
                                T = o(k);
                            let D;
                            if (
                                (fe(T),
                                T.data("fieldData", { attrs: t }),
                                void 0 !== p.stopIndex ? o(d.stage).children().eq(p.stopIndex).before(T) : x.append(T),
                                o(".sortable-options", T).sortable({ update: () => p.updatePreview(T) }),
                                p.updatePreview(T),
                                N())
                            ) {
                                const t = `div.row-${l.rowUniqueId}`;
                                let r = !1;
                                x.children(t).length ? (D = x.children(t)) : ((D = b("div", null, { id: `${k.id}-row`, className: `row row-${l.rowUniqueId} ${ot}` })), (r = !0)),
                                    j && E && (C.attr("id", D.id), C.attr("class", D.className), C.attr("style", ""), C.attr("data-row-id", l.rowUniqueId), (D = C));
                                const n = b("div", null, { id: `${k.id}-cont`, className: `${l.columnSize} ${nt}` });
                                j && S && ("true" === C.attr("prepend") ? o(n).prependTo(D) : o(n).insertAfter(`#${C.attr("appendAfter")}`)),
                                    S || o(n).appendTo(D),
                                    !j && r && T.after(D),
                                    T.appendTo(n),
                                    r &&
                                    ...
                                    xe(D, !0),
                                    l.addedDefaultColumnClass && T.attr("addedDefaultColumnClass", !0),
                                    p.tmpCleanPrevHolder(o(y));
                            }
                            e.typeUserEvents[a] && e.typeUserEvents[a].onadd ? e.typeUserEvents[a].onadd(k) : e.typeUserEvents["*"] && e.typeUserEvents["*"].onadd && e.typeUserEvents["*"].onadd(k),
                                r && (e.editOnAdd && (p.closeAllEdit(), p.toggleEdit(s.lastID, !1)), k.scrollIntoView && e.scrollToFieldOnAdd && k.scrollIntoView({ behavior: "smooth" })),
                                N() && j && S && Re(D, !0),
                                (j = !1),
                                (E = !1),
                                (S = !1);
                    ...
                    function me() {
                        x.children(dt).remove(),
                            x.children(at).each((e, t) => {
                                pe(o(t));
                            }),
                            ...
                            receive: function (e, t) {
                                ...
                                if (n)
                                    if (r) (E = !0), (j = !0), (C = o(t.item).parent());
                                        ...
                                        const e = o(t.item),
                                            r = Oe({}),
                                            n = b("div", null, { id: `${e.find("li").attr("id")}-row`, className: `row row-${r.rowUniqueId} ${ot}` });
                    ...
                    function xe(t, r) {
                        ...
                        n.each((e, t) => {
                            ...
                            i.addClass("colWithInsertButtons"),
                                0 === n.index(i) &&
                                    o(`<button type="button" class="formbuilder-icon-plus btnAddControl ${p.getRowClass(i.parent().attr("class"))}" prepend="true" style='visibility: ${r ? "hidden" : "visible"}'></button>`).insertBefore(i),
                                o(
                                    `<button type="button" class="formbuilder-icon-plus btnAddControl ${p.getRowClass(i.parent().attr("class"))}" appendAfter="${i.attr("id")}" style='visibility: ${r ? "hidden" : "visible"}'></button>`
                                ).insertAfter(i);
                        });
                    }
                    function Ae(e) {
                    ...
                    const ke = function (e, t, r) {
                            ...
                            t = tt(tt({}, { selected: !1, label: "", value: "" }), t);
                            const i = Object.entries(t).map((e) => {
                                ...
                                l = { className: `remove btn ${rt}cancel`, title: h().get("removeMessage") };
                    ...
                    x.on(
                        ...
                        x.on("click touchstart", ".btnAddControl", function (e) {
                            ...
                            (k = A.clone()),
                                ...
                                x.append(k),
                                0 == t.index()
                                    ? k.css({ position: "fixed", left: t.offset().left, top: t.offset().top - o(window).scrollTop() })
                                    : k.css({ position: "fixed", left: t.offset().left - 80, top: t.offset().top - o(window).scrollTop() });
                            const r = k.offset().top + k.outerHeight(),
                                n = o(window).scrollTop() + o(window).innerHeight();
                            r > n && k.css({ top: parseInt(k.css("top")) - (r - n) });
                        }),
                            ...
                            N()
                                ? (function (e, t) {
                                      const r = o(`#className-${t.attr("id")}`),
                                          n = Oe({}),
                                          i = b("div", null, { id: `${e.attr("id")}-row`, className: `row row-${n.rowUniqueId} ${ot}` }),
                                          l = b("div", null, { id: `${e.attr("id")}-cont`, className: `${p.getBootstrapColumnClass(r.val())} ${nt}` });
                                      let a;
                                      o(l).appendTo(i), t.parent().is("div") ? (a = t.closest(at)) : t.parent().is("ul") && (a = t), o(i).insertAfter(a), e.appendTo(l), he(i), me(), Ie(e.attr("id"));
                                  })(n, r)
                                : n.insertAfter(r),
                                we(n),
                                p.tmpCleanPrevHolder(n.find(".prev-holder")),
                                e.editOnAdd && p.closeField(s.lastID, !1);
                        }),
                        N() &&
                            x.on("stageEmptied", () => {
                                c = [];
                    ...
                    function Re(e, t) {
                        ...
                        e.children(`div${st}`).each((e, r) => {
                            ...
                            t || "true" != i.find("li").attr("manuallyChangedDefaultColumnClass")
                                ? p.syncBootstrapColumnWrapperAndClassProperty(r.id.replace("-cont", ""), n)
                                : p.showToast(`Preserving column size of field ${e + 1} because you had personally adjusted it`, 4e3);
                        });
                    }
                    function Ie(e) {
                        if (e) {
                    ...
                    function Pe(e) {
                        if ((void 0 === e && (e = !0), e))
                            (De = !0),
                                p.showToast("Starting Grid Mode - Use the mousewheel to resize.", 1500),
                                A.css("display", "none"),
                    ...
                    function Be() {
                        o(M).find(".gridHelpCurrentRow tbody").empty(),
                            Ee.closest(at)
                                .children(`div${st}`)
                                .each((e, t) => {
                    ...
                    if (
                        (x.on("click touchstart", ".grid-button", (e) => {
                            e.preventDefault();
                            const t = o(e.target).parents(".form-field:eq(0)").attr("id");
                        ...
                        x.on("wheel", function (e) {
                            if (0 !== e.originalEvent.deltaY && De) {
                                ...
                                let s = l;
                                if (
                                    (a.children(`div${st}`).each((e, t) => {
                                        const r = o(`#${t.id}`).find("li").attr("id");
                                        r != Ee.attr("id") && (s += p.getBootstrapColumnValue(o(`#${r}-cont`).attr("class")));
                                    }),
                                    s > 12)
                                )
                                    return void p.showToast('<b class="formbuilder-required">There is a maximum of 12 columns per row</b>');
                        ...
                        x.on("click", ".add-opt", function (e) {
                            ...
                            const t = o(e.target).closest(".form-field").attr("type"),
                                ...
                                s = ye.opts.onAddOption({ selected: !1, label: "", value: "" }, { type: t, index: a.children().length, isMultiple: l });
                            a.append(ke(i.attr("name"), s, l));
                        }),
                        x.on("mouseover mouseout", ".remove, .del-button", (e) => o(e.target).closest("li").toggleClass("delete")),
                        z(),
                    ...
                    return (
                        document.dispatchEvent(v.loaded),
                        (n.actions = {
