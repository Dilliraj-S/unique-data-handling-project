        ...
        try {
            ...
            switch ($reqSet['key']) {
                ...
                case 'business_manage_leave':
                    ...
                    $conditions = [
                        ['column' => 'branches.company_id', 'operator' => '=', 'value' => $dynamic],
                    ];
                    break;
                default:
            ...
            return response()->json( DataHelper::generateResponse($result['data'], $columns, $custom, $reqSet));
        } catch (Exception $e) {
            return response()->json([
                'status' => false,
                'title' => 'Error',
