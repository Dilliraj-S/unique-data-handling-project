            ...
            <div class="my-auto mb-2">
                ...
                <nav>
                    <ol class="breadcrumb mb-0">
                        ...
                        <li class="breadcrumb-item">
                            <a href="{{ url('/dashboard') }}">Designations</a>
                        </li>
                    </ol>
                </nav>
            </div>
                ...
                <div class="card-body">
                    ...
                    <div class="d-flex justify-content-between">
                        <div class="action-area ms-auto">
                            <button class="btn btn-primary skeleton-popup" id="configs-add-btn"
                                data-token="@skeletonToken('business_designations')_a" data-text="Add designations"
                    ...
                    <div class="tab-content" id="skeletonTabsContent">
                        <div class="tab-pane fade show active" id="configs" role="tabpanel" aria-labelledby="configs-tab">
                            <div data-skeleton-table-set="@skeletonToken('business_designations')_f"></div>
                        </div>
                    </div>
                </div>
            </div>
