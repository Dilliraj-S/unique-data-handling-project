{{-- Template: Create Page - Auto-generated --}}
@extends('layouts.system-app')
@section('title', 'Create')
@section('top-style')
    <link href="{{ asset('treasury/panel/css/create-table.css') }}" rel="stylesheet" />
    <style>
                ...
                <div class="card-body">
                    <div class="d-flex justify-content-end align-items-center">
                        <div class="action-area">
                            <button class="btn btn-primary skeleton-popup" data-token="@skeletonToken('central_unique_unq_tables')_a"
                                data-text="Add database" id="configs-add-btn">
                                Create Tables
                            </button>
                        </div>
                    </div>
