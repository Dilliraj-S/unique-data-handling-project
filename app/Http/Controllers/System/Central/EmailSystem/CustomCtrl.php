...
/**
 * Custom controller for handling specific EmailSystem module operations.
 */
class CustomCtrl extends Controller
{
    /**
     * Handles custom operations for the EmailSystem module.
     *
    ...
    public function index(Request $request, array $params): JsonResponse
    {
        try {
            ...
            $data = [
                ...
                'message' => 'Custom operation for EmailSystem completed successfully.'
            ];
            /****************************************************************************************************
             *                                                                                                  *
