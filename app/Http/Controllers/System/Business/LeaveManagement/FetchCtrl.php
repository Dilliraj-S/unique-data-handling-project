        ...
        try {
            ...
            switch ($reqSet['key']) {
                ...
                case 'business_leave_requests':
                    $columns = [
                        'id' => ['leave_requests.id', true],
                        'sno' => ['leave_requests.sno', true],
                        'leave_id' => ['leave_requests.leave_id', true],
                        'employee_id' => ['leave_requests.employee_id', true],
                        'leave_type' => ['leave_requests.leave_type', true],
                        'start_date' => ['leave_requests.start_date', true],
                        'end_date' => ['leave_requests.end_date', true],
                        'reason' => ['leave_requests.reason', true],
                        'status' => ['leave_requests.status', true],
                        'approver_id' => ['leave_requests.approver_id', true],
                        'approved_at' => ['leave_requests.approved_at', true],
                    ];
                    break;
                ...
                case 'business_manage_leave':
                    ...
                    $conditions = [
                        ['column' => 'leave_requests.status', 'operator' => '=', 'value' => $reqSet['id']],
                    ];
                    $statusArr = [
                        "approved" => "success",
                        "rejected" => "danger",
                    ...
                    $custom = [
                        [
                            'type' => 'modify',
                            'column' => 'status',
                            'view' => '<span class="badge bg-' . $statusArr[$reqSet['id']] . '">' . ucfirst($reqSet['id']) . '</span>',
                            'renderHtml' => true
                        ]
                    ];
                ...
                case 'business_branches':
                    $columns = [
                        [
                            ...
                            'legal_name' => ['branches.legal_name', true],
