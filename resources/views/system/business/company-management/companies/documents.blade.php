                ...
                <div class="card-body">
                    ...
                    <div class="d-flex justify-content-between">
                        <div class="action-area ms-auto">
                            <button class="btn btn-primary skeleton-popup" id="configs-add-btn"
                                data-token="@skeletonToken('business_Company_documents')_a" data-text="Add document" data-target="#configs-add-btn">
                                Add Document
                            </button>
                        </div>
                    </div>
                    ...
                    <div class="tab-content" id="skeletonTabsContent">
                        <div class="tab-pane fade show active" id="configs" role="tabpanel" aria-labelledby="configs-tab">
                            <div data-skeleton-table-set="@skeletonToken('business_Company_documents')_f"></div>
                        </div>
                    </div>
                </div>
            </div>
