...
/**
 * Custom controller for handling specific Discrete module operations.
 */
class CustomCtrl extends Controller
{
    /**
     * Handles custom operations for the Discrete module.
     *
    ...
    public function index(Request $request, array $params): JsonResponse
    {
        try {
            ...
            $data = [
                ...
                'message' => 'Custom operation for Discrete completed successfully.'
            ];
            /****************************************************************************************************
             *                                                                                                  *
