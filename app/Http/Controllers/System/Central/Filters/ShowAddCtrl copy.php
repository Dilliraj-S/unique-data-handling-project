    ...
    break;
                ...
                case 'central_create_table':
                    ...
                    <div class="col-12">
                        ...
                        <div class="float-input-control">
                            <select class="form-float-input" id="database_name" name="database_name" required>
                            ...
                            <label for="database_name" class="form-float-label">
                    ...
                    <div class="col-12 mt-4">
                        <div class="float-input-control">
                            <input type="text" class="form-float-input" id="table_name" 
                                placeholder="Enter new table name" name="table_name" required>
                            <label for="table_name" class="form-float-label">
                    ...
                    <div class="col-12 mt-4">
                        <div class="float-input-control">
                            <textarea class="form-float-input" id="table_description"
                                placeholder="Enter table description (optional)"
                                name="table_description" rows="3"></textarea>
                            <label for="table_description" class="form-float-label">Description</label>
                        </div>
                    </div>

                    <div class="col-12 mt-4">
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" id="copy_structure" name="copy_structure" checked>
                            <label class="form-check-label" for="copy_structure">
                                Copy original table structure
                            </label>
                        </div>
                    </div>';
                    ...
                    $popup = [
                        ...
                        'size'       => 'modal-md',
                        'position'   => 'end',
                        'label'      => '<i class="fa fa-table me-1"></i> Create Table',
                        'button'     => 'Create Table',
                        'script'     => <<<SCRIPT
