...
/**
 * Controller for rendering the view form for Discrete entities.
 */
class ViewCtrl extends Controller
{
    /**
     * Renders a popup form for viewing Discrete entities.
     *
        ...
        try {
            ...
            switch ($reqSet['key']) {
                case 'Discrete_entities':
                    ...
                    $message = 'Discrete entity view form loaded successfully.';
                    break;
                default:
                    $detailsHtml = '';
                    if ($allowDefault) {
