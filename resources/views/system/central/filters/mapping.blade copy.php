                            ...
                            <div class="card-body p-4">
                                ...
                                <div class="mb-3">
                                    <div class="input-group">
                                        <span class="input-group-text bg-primary text-white border-0 rounded-start">mapped_</span>
                                        <input type="text" class="form-control border-primary rounded-end" id="newTableName"
                                               placeholder="Enter table name">
                                    </div>
                                </div>

                                <!-- Main Database Selection and Create Table Button -->
                                <div class="row g-3 align-items-center mb-4">
                                    ...
                                    <div class="col-md-5">
                                        <button class="btn btn-success btn-lg rounded-pill shadow-sm" id="createTableBtn" title="Create table from CSV">
                                ...
                                <div class="row g-3 align-items-center">
                                    <div class="col-md-7">
                                        <input type="file" class="form-control border-primary" id="fileInput" name="csv_file"
                                               accept=".csv,.xlsx">
                                    </div>
                                    <div class="col-md-5">
                                        <button class="btn btn-primary btn-lg rounded-pill shadow-sm" id="uploadFileBtn" title="Upload CSV/XLSX file">
                                ...
                                <div id="uploadStatus" class="mt-3 d-none">
                                    <div class="alert alert-info p-2 mb-0">
                                        <i class="bi bi-hourglass-split me-1"></i> Uploading... Please wait
                                    </div>
                                </div>
                    ...
                    <div class="col-lg-6 section-container">
                        <div class="card border-primary">
                            ...
                            <div class="card-body mt-3">
                                        ...
                                        <div class="col-12">
                                            <div class="btn-group w-100" role="group">
                                                <button class="btn btn-success" id="autoMatchBtn" title="Automatically match similar field names">
                                                    <i class="bi bi-magic"></i> Auto Match Fields
                                                </button>
                                ...
                                <div class="mt-3">
                                    <label class="form-label">Selected Pairs <span id="pairCount" class="badge bg-primary">0</span></label>
