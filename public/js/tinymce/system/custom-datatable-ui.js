...
class CustomDataTableUI {
  ...
  updateTable() {
    ...
    if (paginationElement) {
      console.log('Found existing pagination element');
      const paginationRow = paginationElement.closest('.row');
      if (paginationRow) {
        console.log('Updating existing pagination row');
        paginationRow.innerHTML = this.renderPagination();
      }
    } else {
      console.log('No existing pagination found, trying to add new pagination');
