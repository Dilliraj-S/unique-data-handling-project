...
@section('content')
    <div class="container">
        <ul class="nav nav-tabs" id="emailSchedulerTabs" role="tablist">
            <li class="nav-item" role="presentation">
                <button class="nav-link active" id="audience-tab" data-bs-toggle="tab" data-bs-target="#audience"
                    type="button" role="tab" aria-controls="audience" aria-selected="true"><i
                        class="fas fa-users me-2"></i>Audience</button>
            </li>
            <li class="nav-item" role="presentation">
                <button class="nav-link" id="templates-tab" data-bs-toggle="tab" data-bs-target="#templates" type="button"
                    role="tab" aria-controls="templates" aria-selected="false"><i
                        class="fas fa-file-alt me-2"></i>Templates</button>
            </li>
            <li class="nav-item" role="presentation">
                <button class="nav-link" id="campaigns-tab" data-bs-toggle="tab" data-bs-target="#campaigns" type="button"
                    role="tab" aria-controls="campaigns" aria-selected="false"><i
                        class="fas fa-bullhorn me-2"></i>Campaigns</button>
            </li>
            <li class="nav-item" role="presentation">
                <button class="nav-link" id="preview-send-tab" data-bs-toggle="tab" data-bs-target="#preview-send"
                    type="button" role="tab" aria-controls="preview-send" aria-selected="false"><i
                        class="fas fa-eye me-2"></i>Preview & Send</button>
            </li>
        </ul>
        <div class="tab-content" id="emailSchedulerTabContent">
            ...
            <div class="tab-pane fade show active" id="audience" role="tabpanel" aria-labelledby="audience-tab">
                <div class="card">
                    <div class="card-header">
                        Audience Management
                        <button class="btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#addAudienceModal"><i
                                class="fas fa-plus me-2"></i>Add Audience</button>
                    </div>
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center mb-4">
                            <div>
                                <button class="btn btn-danger btn-sm" id="delete-selected-btn" disabled
                                    title="Delete Selected"><i class="fas fa-trash me-2"></i>Delete Selected</button>
                                <button class="btn btn-danger btn-sm ms-2" id="clear-table-btn" disabled
                                    title="Clear Table"><i class="fas fa-trash-alt me-2"></i>Delete All</button>
                            </div>
                        ...
                        <div class="table-responsive" style="max-height: 400px; overflow-y: auto;">
                            <table class="table table-striped">
                                <thead>
                                    <tr>
                                        <th scope="col"><input type="checkbox" id="select-all-audience"
                                                aria-label="Select all audiences"></th>
                        ...
                        <nav aria-label="Audience pagination" class="mt-4">
            ...
            <!-- Templates Tab -->
            <div class="tab-pane fade float-input-control" id="templates" role="tabpanel" aria-labelledby="templates-tab">
                <div class="card">
                    <div class="card-header">
                        Templates
                        <button class="btn btn-primary btn-sm" id="add-template-btn"><i class="fas fa-plus me-2"></i>Add
                            Template</button>
                    </div>
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center mb-4">
                        ...
                        <div class="table-responsive" style="max-height: 400px; overflow-y: auto;">
                            <table class="table table-striped">
                                <thead>
                                    <tr>
                                        <th scope="col"><input type="checkbox" id="select-all-templates"
                                                aria-label="Select all templates"></th>
                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <button class="btn btn-primary btn-sm" data-bs-toggle="modal"
                            data-bs-target="#addCampaignModal"><i class="fas fa-plus me-2"></i>Add Campaign</button>
                    </div>
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center mb-4">
                            <div>
                        ...
                        <div class="table-responsive" style="max-height: 400px; overflow-y: auto;">
                            <table class="table table-striped">
                                <thead>
                                    <tr>
                                        <th scope="col"><input type="checkbox" id="select-all-campaigns"
                                                aria-label="Select all campaigns"></th>
                                        <th scope="col">Name</th>
                                ...
                                <form id="campaign-form">
                                    ...
                                    <div class="mb-4">
                                        <div class="float-input-control">
                                            ...
                                            <label class="form-float-label" for="campaign-name">Campaign Name</label>
                                        </div>
                                    </div>
                                    <div class="mb-4">
                                    ...
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link active" id="manual-add-audience-tab" data-bs-toggle="tab"
                                            ...
                                            aria-controls="manual-add-audience" aria-selected="true"><i
                                                class="fas fa-user-plus me-2"></i>Manually Add</button>
                                    </li>
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link" id="import-csv-audience-tab" data-bs-toggle="tab"
                                            ...
                                            aria-controls="import-csv-audience" aria-selected="false"><i
                                                class="fas fa-file-csv me-2"></i>Import CSV</button>
                                    </li>
                                </ul>
                                <div class="tab-content mt-3" id="createAudienceTabContent">
                                    <div class="tab-pane fade show active" id="manual-add-audience" role="tabpanel"
                                        ...
                                        <div class="mb-4">
                                            ...
                                            <textarea class="form-control" id="subscribers-input-create" rows="6"
            ...
            <div class="tab-pane fade" id="preview-send" role="tabpanel" aria-labelledby="preview-send-tab">
                <ul class="nav nav-tabs" id="previewSendTabs" role="tablist">
                    <li class="nav-item" role="presentation">
                        <button class="nav-link active" id="preview-tab" data-bs-toggle="tab"
                            data-bs-target="#preview-tab-pane" type="button" role="tab"
                            aria-controls="preview-tab-pane" aria-selected="true"><i
                                class="fas fa-eye me-2"></i>Preview</button>
                    </li>
                    <li class="nav-item" role="presentation">
                        <button class="nav-link" id="send-tab" data-bs-toggle="tab" data-bs-target="#send-tab-pane"
                            type="button" role="tab" aria-controls="send-tab-pane" aria-selected="false"><i
                                class="fas fa-paper-plane me-2"></i>Send</button>
                    </li>
                </ul>
                <div class="tab-content pt-3" id="previewSendTabContent">
                    <!-- Preview Tab Content -->
                            ...
                            <div class="card-body">
                                <form id="preview-form">
                                    <div class=" float-input-control mb-4">
                                        <select class="form-float-input" id="preview-campaign-select">
                                            <option value=""></option>
                                        </select>
                                        <label for="preview-campaign-select" class="form-float-label">Select
                                            Campaign</label>
                                    </div>
                                                    ...
                                                    <div class="d-flex justify-content-between align-items-center mb-3">
                                                        <div>
                                                            <button class="btn btn-danger btn-sm" id="delete-selected-btn"
                                                                disabled title="Delete Selected"><i
                                                                    class="fas fa-trash me-2"></i>Delete Selected</button>
                                                            <button class="btn btn-danger btn-sm ms-2"
                                                                id="clear-table-btn" disabled title="Clear Table"><i
                                                                    class="fas fa-trash-alt me-2"></i>Delete All</button>
                                                        </div>
                                                        <div class="d-flex align-items-center">
                                                            <span class="me-3">Page Size:</span>
                                                            ...
                                                            <thead>
                                                                <tr>
                                                                    <th scope="col"><input type="checkbox"
                                                                            ...
                                                                            aria-label="Select all subscribers"></th>
                                                                    <th scope="col">ID</th>
                    ...
                    <!-- Send Tab Content -->
                    <div class="tab-pane fade" id="send-tab-pane" role="tabpanel" aria-labelledby="send-tab">
                        <div class="card">
                            <div class="card-header">Send or Schedule Campaign</div>
                            <div class="card-body">
                                <form id="send-immediately-form">
                                    <div class="row">
                                        <div class="col-md-6 mb-4">
                                            <label for="campaign-select" class="form-label">Select Campaign</label>
                                            <select class="form-control" id="campaign-select" name="campaign_id"
                                                required>
                                                <option value="">-- Select Campaign --</option>
                                            </select>
                                        </div>
                                        <div class="col-md-6 mb-4">
                                            <label for="fromEmailSelect" class="form-label">From Email (by Region)</label>
                                            ...
                                            <div class="invalid-feedback">
                                                Please select at least one email account.</div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-6 mb-4">
                                            <label for="time-gap" class="form-label">Time Gap Between Emails
                                                (seconds)</label>
                                            <input type="number" class="form-control" id="time-gap" name="time_gap"
                                        ...
                                        <div class="col-md-6 mb-4">
                                            <label for="batch-size" class="form-label">Batch Size (emails per
                                                account)</label>
                                            <input type="number" class="form-control" id="batch-size" name="batch_size"
                                                min="1" value="2" required>
                                            <div class="invalid-feedback">Batch size must be at least 1.</div>
                                        </div>
                                    </div>
                                    <div class="mb-4">
                                        <label for="subject" class="form-label">Subject</label>
                                        <input type="text" class="form-control" id="subject" name="subject"
                                            maxlength="255" required placeholder="Enter email subject">
                                        <div class="invalid-feedback">Subject is required and must be 255 characters or
                                            less.</div>
                                    </div>
                                    <div class="d-flex gap-3">
                                        <button type="submit" class="btn btn-primary" id="send-now-btn"><i
                                                class="fas fa-paper-plane me-2"></i>Send
                                            Now</button>
                                ...
                                <div id="send-message" class="mt-4"></div>
                                <!-- Schedule Modal -->
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <form id="schedule-campaign-form">
                                                <div class="modal-body">
                                                    ...
                                                    <div class="mb-4" style="position: relative; z-index: 1055;">
                                                ...
                                                <div class="modal-footer">
                                                    ...
                                                    <button type="submit" class="btn btn-primary">
                                                        <span
                                                            class="spinner-border spinner-border-sm loading-spinner d-none"
                            ...
                            <ul class="nav nav-tabs" id="audienceTabs" role="tablist">
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link active" id="new-tab" data-bs-toggle="tab"
                                        data-bs-target="#new-audience" type="button" role="tab">
                                        <i class="fas fa-user-plus me-2"></i>New Audience
                                    </button>
                                </li>
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link" id="existing-tab" data-bs-toggle="tab"
                                        data-bs-target="#existing-audience" type="button" role="tab">
                                        <i class="fas fa-users me-2"></i>Existing Audience
                                    </button>
                                </li>
                            </ul>

                            <div class="tab-content mt-1" id="audienceTabsContent">
                                <!-- New Audience Form -->
                                <div class="tab-pane fade show active" id="new-audience" role="tabpanel">
                                    <form id="audience-form">
                                        ...
                                        <div class="mb-4">
                                            <div class="float-input-control">
                                                <input type="text" class="form-float-input" id="audience-name"
                                                    required>
                                ...
                                <!-- Existing Audience Selection -->
                                <div class="tab-pane fade" id="existing-audience" role="tabpanel">
                                    <div class="float-input-control">
                                        <select
                                            class="form-float-input form-select form-select-lg dyna-select-dropdown h-auto"
                                        ...
                                        <label for="editaudience" class="form-float-label">Existing Audience</label>
                                    </div>
                ...
                <div class="modal-dialog modal-xl">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="mb-4">
                                <div class="float-input-control">
                                    <input type="text" class="form-float-input" id="editor-title" required
                                        placeholder=" ">
                            ...
                            <div class="mb-4">
                                <div class="float-input-control">
                                    <select class="form-float-input" id="editor-switch" required placeholder=" ">
                            ...
                            <div id="tinymce-editor-container" style="display: none;">
                                <textarea id="tinymce-editor" class="form-control" style="min-height: 250px;"></textarea>
                            </div>
    ...
    <script>
        ...
        `,
            ...
            $('#audience-form').on('submit', function(e) {
                ...
                const name = $('#addAudienceModal #audience-name').val().trim();
                ...
                $.ajax({
                    ...
                    .done(response => {
                        if (!id && response && response.id) {
                            // Same behavior as your view button
            ...
            // Ensures campaign dropdowns are populated when switching to the Send tab
            $(function() {
                $('button[data-bs-toggle="tab"]').on('shown.bs.tab', function(e) {
                    const target = $(e.target).attr('data-bs-target');
                    if (target === '#send-tab-pane') {
                        if (typeof populateSendSettingsDropdowns === 'function') {
                            populateSendSettingsDropdowns();
                        }
                    }
                });
