...
/**
 * Controller for rendering the edit form for MainMenu entities.
 */
class ShowEditCtrl extends Controller
{
    /**
     * Renders a popup form for editing MainMenu entities.
     *
            ...
            switch ($reqSet['key']) {
                case 'MainMenu_entities':
                    $popup = [
                        ...
                        'size' => 'modal-md',
                        'position' => 'end',
                        'label' => '<i class="fa-regular fa-folder me-1"></i> Edit MainMenu Entity',
