...
@section('title', 'Devices | Gotit HR Management Software')
@section('content')
    <div class="content">
        <!-- Breadcrumb -->
                ...
                <div class="card-body">
                        ...
                        <ul class="nav nav-tabs nav-tabs-solid bg-transparent border-bottom-0 mb-3 data-skl-action"
                            ...
                            <li class="nav-item">
                                <a class="nav-link active" id="Devices-tab" data-skl-action="b" data-bs-toggle="tab"
                                    ...
                                    data-token="@skeletonToken('business_devices')_a" data-text="Add Devices"
                                    data-target="#Devices-add-btn">Devices</a>
                            </li>
                        </ul>
                    ...
                    <div class="tab-content" id="skeletonTabsContent">
                        <div class="tab-pane fade show active" id="devices" role="tabpanel" aria-labelledby="devices-tab">
                            <div data-skeleton-table-set="@skeletonToken('business_devices')_f"></div>
                        </div>
                    </div>
                </div>
            </div>
