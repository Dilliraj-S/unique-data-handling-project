...
class Select extends Controller
{
    ...
    {
        \Log::info('Select options request:', [
            'params' => $params,
            'request' => $request->all(),
        ...
        try {
            ...
            $initialLoad = $request->input('initial_load', false);
            $reqSet= Skeleton::resolveToken($table);
            ...
            if (!$initialLoad) {
                ...
                \Log::info('Select options response:', [
                'table' => $fullTableName,
                'search' => $searchTerm,
            ...
            \Log::error('SelectCtrl: Error fetching dropdown data', [
