...
/**
 * Custom controller for handling specific QueryNest module operations.
 */
class CustomCtrl extends Controller
{
    /**
     * Handles custom operations for the QueryNest module.
     *
    ...
    public function index(Request $request, array $params): JsonResponse
    {
        try {
            ...
            $data = [
                ...
                'message' => 'Custom operation for QueryNest completed successfully.'
            ];
            /****************************************************************************************************
             *                                                                                                  *
