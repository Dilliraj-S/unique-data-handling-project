...
/**
 * Custom controller for handling specific QueryChain module operations.
 */
class CustomCtrl extends Controller
{
    /**
     * Handles custom operations for the QueryChain module.
     *
    ...
    public function index(Request $request, array $params): JsonResponse
    {
        try {
            ...
            $data = [
                ...
                'message' => 'Custom operation for QueryChain completed successfully.'
            ];
            /****************************************************************************************************
             *                                                                                                  *
