    ...
    <div class="tab-content" id="emailSchedulerTabContent">
        ...
        <div class="tab-pane fade" id="campaigns" role="tabpanel" aria-labelledby="campaigns-tab">
            <div class="card">
                <div class="card-header">
                    Campaigns
                    <button class="btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#addCampaignModal">Add
                        Campaign</button>
                </div>
                <div class="card-body">
                    <div class="d-flex justify-content-between mb-3">
            ...
            <ul class="nav nav-tabs sub-tabs" id="previewSendTabs" role="tablist">
                ...
                <li class="nav-item">
                    <button class="nav-link" id="send-tab" data-bs-toggle="tab" data-bs-target="#send" type="button"
                        role="tab" aria-controls="send" aria-selected="false">Send</button>
                </li>
            </ul>
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <div class="table-responsive">
                                                    <table class="table table-bordered">
                                                        <thead>
                                                            <tr>
                                                                <th><input type="checkbox" id="select-all-subscribers">
                                                                </th>
                                                                <th>ID</th>
                                                                <th>First Name</th>
                                                                <th>Last Name</th>
                                ...
                                <div class="tab-pane fade show active" id="send-campaign" role="tabpanel"
                                    ...
                                    <form id="send-immediately-form" class="mt-4">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" id="send-subject" name="subject"
                                                maxlength="255" required placeholder="Splunk & IBM QRadar Samples">
                                            ...
                                            <form id="schedule-campaign-form" novalidate>
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <select class="form-control dyna-select-dropdown"
                                                        id="schedule-from-email" name="from_emails[]" multiple required>
                                                        <option value="__select_all__">-- Select All --</option>
                                                        @php
                                                        $regions = DB::connection('pluto')
                                                        ->table('email_accounts')
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <select class="form-control" id="schedule-timezone" name="timezone"
                                                        required>
                                                ...
                                                <div class="mb-3">
                                                    <label for="schedule-batch-size" class="form-label">Batch
                                                        Size</label>
                                                    <input type="number" class="form-control" id="schedule-batch-size"
                                                        name="batch_size" value="2" min="1" required>
                                                </div>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="tab-content mt-3" id="audienceTabsContent">
                            ...
                            <div class="tab-pane fade" id="existing-audience" role="tabpanel">
                                <select class="form-select form-select-lg dyna-select-dropdown h-auto" name="audiences"
                                    id="editaudience">
                                    @php
