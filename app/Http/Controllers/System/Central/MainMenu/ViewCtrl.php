...
/**
 * Controller for rendering the view form for MainMenu entities.
 */
class ViewCtrl extends Controller
{
    /**
     * Renders a popup form for viewing MainMenu entities.
     *
        ...
        try {
            ...
            switch ($reqSet['key']) {
                case 'MainMenu_entities':
                    ...
                    $message = 'MainMenu entity view form loaded successfully.';
                    break;
                default:
