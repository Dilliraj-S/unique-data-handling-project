...
/**
 * Custom controller for handling specific MainMenu module operations.
 */
class CustomCtrl extends Controller
{
    /**
     * Handles custom operations for the MainMenu module.
     *
    ...
    public function index(Request $request, array $params): JsonResponse
    {
        try {
            ...
            $data = [
                ...
                'message' => 'Custom operation for MainMenu completed successfully.'
            ];
            /****************************************************************************************************
             *                                                                                                  *
