...
/**
 * Controller for rendering navigation views for the Discrete module.
 */
class NavCtrl extends Controller
{
    ...
    public function index(Request $request, array $params)
    {
        try {
            ...
            $baseView = 'system.' . strtolower('central') . '.' . strtolower('Discrete');
            $module = $params['module'] ?? 'Discrete';
            ...
            $data = [
                ...
                'token' => $token,
                'title' => 'Page Loaded',
                'message' => 'Discrete module page loaded successfully.'
            ];
            /****************************************************************************************************
             *                                                                                                  *
