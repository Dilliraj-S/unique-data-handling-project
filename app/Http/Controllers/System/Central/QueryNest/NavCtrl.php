...
/**
 * Controller for rendering navigation views for the QueryNest module.
 */
class NavCtrl extends Controller
{
    ...
    {
        try {
            $baseView = 'system.' . strtolower('central') . '.' . strtolower('Query-Nest');
            $module = $params['module'] ?? 'QueryNest';
            ...
            $data = [
                ...
                'token' => $token,
                'title' => 'Page Loaded',
                'message' => 'QueryNest module page loaded successfully.'
            ];
            /****************************************************************************************************
             *                                                                                                  *
