        ...
        try {
            ...
            switch ($reqSet['key']) {
                ...
                case 'business_geofence':
                    $columns = [
                        'id' => ['geofences.id', true],
                        'geofence_id' => ['geofences.geofence_id', true],
                        'name' => ['geofences.name', true],
                        'longitude' => ['geofences.longitude', true],
                        'latitude' => ['geofences.latitude', true],
                        'radius' => ['geofences.radius', true],
                        'allow_picture' => ['geofences.allow_picture', true],
                        'within_radius' => ['geofences.within_radius', true],
